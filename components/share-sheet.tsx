...
export function ShareSheet({ files, onClose }: ShareSheetProps) {
  ...
  return (
    <>
      ...
      />
      <div
        className={`fixed bottom-0 left-0 right-0 z-[80] rounded-t-[28px] bg-white dark:bg-[#252220] px-5 pt-4 pb-[calc(28px+env(safe-area-inset-bottom,0px))] shadow-2xl ${isClosing ? "sheet-exit" : "sheet-enter"}`}
      >
